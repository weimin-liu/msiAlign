...
### Crawl the metadata to a sqlite database:
Before you can use the MSI machine coordinate transformation, you need to crawl the metadata to a sqlite database. Click File - Crawl Metadata, and select the metadata directory. Then you will be asked to save the metadata to a sqlite database.
You will also be asked if you want to collect the msi images. If you choose to collect the msi images, you will be asked to select a target directory to save the msi images.
